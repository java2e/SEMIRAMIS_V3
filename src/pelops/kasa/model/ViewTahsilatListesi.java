...
public class ViewTahsilatListesi {
	...
	public String getDosya_statusu() {
		return dosya_statusu;
	}
	public void setDosya_statusu(String dosya_statusu) {
		this.dosya_statusu = dosya_statusu;
	}
