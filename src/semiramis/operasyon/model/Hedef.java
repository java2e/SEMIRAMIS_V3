...
public class Hedef {
	...
	private String ilgili_ay_str;
	private String ilgili_yil_str;

	public String getIlgili_ay_str() {
		return ilgili_ay_str;
	}

	public void setIlgili_ay_str(String ilgili_ay_str) {
		this.ilgili_ay_str = ilgili_ay_str;
	}

	public String getIlgili_yil_str() {
		return ilgili_yil_str;
	}

	public void setIlgili_yil_str(String ilgili_yil_str) {
		this.ilgili_yil_str = ilgili_yil_str;
	}
